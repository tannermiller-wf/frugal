...
impl<T> TInputProtocol<T> for TCompactInputProtocol<T>
where
    T: TReadTransport,
{
...
impl TCompactInputProtocolFactory {
    ...
    pub fn create<R>(&self, transport: R) -> TCompactInputProtocol<R>
    where
        R: TReadTransport,
    {
...
impl<T> TOutputProtocol<T> for TCompactOutputProtocol<T>
where
    T: TWriteTransport,
{
...
impl TCompactOutputProtocolFactory {
    ...
    pub fn create<W>(&self, transport: W) -> TCompactOutputProtocol<W>
    where
        W: TWriteTransport,
    {
...
mod tests {
    ...
    fn must_write_message_begin_0() {
        ...
        let expected: [u8; 8] = [
            ...
            0xDE, 0x06, /* zig-zag varint sequence number */
    ...
    fn must_write_message_begin_1() {
        ...
        let expected: [u8; 9] = [
            ...
            0xA8, 0x89, 0x79, /* zig-zag varint sequence number */
            0x03, /* message-name length */
            0x62, 0x61, 0x72, /* "bar" */
        ];
    ...
    fn must_write_struct_with_long_fields() {
        ...
        let expected: [u8; 8] = [
            ...
            0x0A, /* field type */
            0xC6, 0x01, /* zig-zag varint field id */
            0x00, /* field stop */
        ];
    ...
    fn must_write_struct_with_mix_of_long_and_delta_fields() {
        ...
        let expected: [u8; 10] = [
            ...
            0x0A, /* field type */
            0xD0, 0x0F, /* zig-zag varint field id */
            0x0A, /* field type */
            0xA2, 0x1F, /* zig-zag varint field id */
