...
impl TestingDefaults {
    ...
    where
        T: thrift::protocol::TInputProtocol,
    {
        let status = iprot.read_i32().map(HealthCondition::from_i32)?;
        self.status = status;
        Ok(())
    }
    ...
    where
        T: thrift::protocol::TInputProtocol,
    {
        let base_status = iprot.read_i32().map(rust::BaseHealthCondition::from_i32)?;
        ...
        T: thrift::protocol::TOutputProtocol,
    {
        let bin_field = match self.bin_field {
            Some(bin_field) => bin_field,
            None => return Ok(()),
        };
        oprot.write_field_begin(&thrift::protocol::TFieldIdentifier {
            name: Some("bin_field".into()),
            field_type: thrift::protocol::TType::Bytes,
            id: Some(9),
        })?;
        ...
        T: thrift::protocol::TOutputProtocol,
    {
        ...
        oprot.write_map_begin(&thrift::protocol::TMapIdentifier {
            key_type: thrift::protocol::TType::String,
            value_type: thrift::protocol::TType::String,
        ...
        T: thrift::protocol::TOutputProtocol,
    {
        ...
        oprot.write_i32(base_status as i32)?;
        oprot.write_field_end()
    }
}
...
impl EventWrapper {
        ...
        T: thrift::protocol::TInputProtocol,
    {
        ...
        for _ in 0..list_id.size {
            let enums_item = iprot.read_i32().map(ItsAnEnum::from_i32)?;
        ...
        T: thrift::protocol::TOutputProtocol,
    {
        ...
        oprot.write_map_begin(&thrift::protocol::TMapIdentifier {
            key_type: thrift::protocol::TType::I64,
            value_type: thrift::protocol::TType::Struct,
        ...
        T: thrift::protocol::TOutputProtocol,
    {
        ...
        for enums_item in enums {
            oprot.write_i32(enums_item as i32)?;
        }
        oprot.write_list_end()?;
        oprot.write_field_end()
    }
        ...
        T: thrift::protocol::TOutputProtocol,
    {
        let typedef_of_typedef = match self.typedef_of_typedef {
            Some(typedef_of_typedef) => typedef_of_typedef,
            None => return Ok(()),
        };
        oprot.write_field_begin(&thrift::protocol::TFieldIdentifier {
...
impl FooArgs {
        ...
        T: thrift::protocol::TOutputProtocol,
    {
        let message_args = match self.message_args {
            Some(message_args) => message_args,
            None => return Ok(()),
        };
        oprot.write_field_begin(&thrift::protocol::TFieldIdentifier {
        ...
        T: thrift::protocol::TOutputProtocol,
    {
        ...
        match *self {
            ...
            TestingUnions::Requests(requests) => {
                oprot.write_map_begin(&thrift::protocol::TMapIdentifier {
                    key_type: thrift::protocol::TType::I32,
                    value_type: thrift::protocol::TType::String,
